...
git clone https://github.com/YOUR-USERNAME/filter_Zone.git
cd filter_Zone
```
...
```bash
# Add upstream remote
git remote add upstream https://github.com/welshdog/filter_Zone.git
...
- 🐛 **Issues:** [GitHub Issues](https://github.com/welshdog/filter_Zone/issues)

...
class UltraHealthBot:
    ...
    def run_empire_health_scan(self):
        ...
        logger.info("🌌 Running ULTRA Empire Health Scan...")
...
async def on_ready():
    ...
    logger.info("🌌 🎯 Discord commands available:")
    logger.info("🌌   !health - Quick empire health check")
    logger.info("🌌   !ultra-scan - Full comprehensive scan")
    logger.info("🌌   !rewards - Check BROski$ balance")
    logger.info("🌌   !celebrate - Manual celebration")
    logger.info("🌌   !status - Bot status and stats")
...
async def auto_health_monitor():
    ...
    logger.info("🌌 🔄 Running automatic health monitoring...")
...
if __name__ == "__main__":
    ...
    logger.info("🌌 🏥 Health monitoring systems activated")
    logger.info("🌌 ="*60)
    
    try:
        bot.run(BOT_TOKEN)
    except discord.LoginFailure:
        logger.info("🌌 ❌ LOGIN FAILED - Invalid bot token")
        logger.info("🌌 🔧 Please run DISCORD_SETUP_SIMPLE.py to fix token")
    except Exception as e:
        print(f"❌ Bot error: {e}")
        logger.info("🌌 🔧 Check your Discord bot configuration")

...
import requests
logger.info("🌌 📊💎⚡ GRAFANA AI NATURAL LANGUAGE INTEGRATION ⚡💎📊")
logger.info("🌌 =" * 70)
...
try:
    ...
    logger.info("🌌 ✅ HF Client connected for Grafana AI")
...
"""
        ...
        def save_query_history(self, processed_queries):
            ...
            logger.info("🌌 💾 Grafana AI query history saved!")

    # Demo queries for testing
    def demo_grafana_ai():
        """🎯 Demonstrate Grafana AI capabilities"""

        logger.info("🌌 🚀 Initializing Grafana AI Enhancer...")
    ...
    if __name__ == "__main__":
        logger.info("🌌 📊 Starting Grafana AI Integration...")
        demo_results = demo_grafana_ai()
        logger.info("🌌 🎊 Grafana AI Integration Complete!")

except ImportError as e:
    print(f"❌ Missing dependencies: {e}")
    logger.info("🌌 💡 Run: pip install huggingface_hub requests")

...
Timestamp: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}
    ...
    try:
        ...
        logger.info("🌌    📊 Analytics module imported successfully")
    ...
    try:
        ...
        if result == 0:
            ...
            logger.info("🌌    🌐 WebSocket server: ⚠️ Not detected (may not be running)")
        
        logger.info("🌌 ✅ Integration capabilities test: PASSED")

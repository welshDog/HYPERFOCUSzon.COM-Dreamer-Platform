...
print("🚨 STARTING ULTRA SIMPLE DEBUG BOT...")
print("=" * 50)
...
print("Step 2: Testing Discord.py import...")
try:
    import discord
...
print("Step 3: Testing discord.ext.commands...")
try:
...
print("Step 4: Testing token loading...")
try:
    import os
...
print("Step 5: Creating minimal bot...")
try:
...
print("Step 6: Setting up bot events...")
...
# Step 7: Run bot
print("Step 7: Starting bot connection...")
print("🚨 If bot hangs here, the issue is with Discord connection...")
...
try:
    ...
    print("💡 Check your Discord Developer Portal")
...
print("🚨 Bot execution completed (this shouldn't print if bot is running)")

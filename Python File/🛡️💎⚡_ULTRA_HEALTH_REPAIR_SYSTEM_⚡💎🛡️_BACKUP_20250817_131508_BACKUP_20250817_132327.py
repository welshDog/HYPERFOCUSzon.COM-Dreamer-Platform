...
================================
    ...
    def repair_docker_containers(self):
        ...
        print("🐳 Repairing Docker containers...")
        ...
        try:
            ...
            if unhealthy_containers and unhealthy_containers[0]:
                ...
                print("   ⏳ Waiting for container initialization...")
                time.sleep(30)
            else:
                print("   ✅ All Docker containers healthy")
    ...
    def repair_system_services(self):
        ...
        print("🔧 Repairing system services...")
        ...
        try:
            ...
            if result.stdout.strip():
                ...
                print("   ✅ All automatic services running")
    ...
    def repair_python_packages(self):
        ...
        print("📦 Repairing Python packages...")
    ...
    def cleanup_docker_cache(self):
        ...
        try:
            ...
            if cleanup_result.returncode == 0:
                ...
                print("   ⚠️ Docker cache cleanup issues")
    ...
    def verify_system_health(self):
        ...
        print("🔍 Verifying system health post-repair...")

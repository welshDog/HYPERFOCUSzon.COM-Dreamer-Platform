...
def main():
    ...
    print("🎮 Starting realistic test data generation for v2.0 demonstration...")
    
    # Ensure database exists
    db_path = Path("dopamine_guardian.db")
    if not db_path.exists():
        print("⚠️ Database not found. Run the main system first to create schema.")
        return
...
Launch the full deployment system to see everything in action!
        ...
        print("❌ Test data generation failed. Check the logs above.")

...
class SendMeNFTWeb3Configurator:
    ...
    def prepare_web3_portal_package(self) -> str:
        ...
        logger.info("🌌 🏛️ USING PRE-EXISTING LEGENDARY PORTAL: bafkreigmtm6ejkotspttay7xgnvjo6e2nffbhcwfqx4g57b66btmdaljiq")
        ...
        if Path(legendary_portal_zip).exists():
            ...
            logger.info("🌌 ✅ LEGENDARY PORTAL EXTRACTED SUCCESSFULLY!")
            ...
            if index_files:
                ...
                logger.info("🌌 ⚠️ No index.html found in legendary portal, creating enhanced version...")
                index_content = self.create_fallback_legendary_portal()
        else:
            logger.info("🌌 ⚠️ Legendary portal zip not found, creating enhanced version...")
            index_content = self.create_fallback_legendary_portal()
...
"""
        ...
        with open(file_path, 'rb') as f:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    logger.info("🌌 🎊 LEGENDARY IPFS SINGLE FILE UPLOAD SUCCESS!")
    ...
    def pin_directory_as_zip_to_ipfs(self, folder_path: str) -> Dict[str, Any]:
        ...
        logger.info("🌌 🗜️ Creating ZIP archive for legendary portal...")
...
"""
    ...
    def deploy_web3_domain_portal(self) -> None:
        ...
        logger.info("🌌 💎🌐🚀 INITIATING WEB3 DOMAIN + IPFS DEPLOYMENT 🚀🌐💎")
        logger.info("🌌 =" * 80)
        print(f"🌐 Domain: {self.domain_name}")
        logger.info("🌌 🏗️ Architecture: Unstoppable Domains + IPFS")
        logger.info("🌌 💾 Storage: Pinata Cloud (Permanent)")
        logger.info("🌌 🔐 Authentication: JWT Bearer Token")
        logger.info("🌌 🌟 Status: IMMORTAL WEB3 DEPLOYMENT")
        logger.info("🌌 =" * 80)

        # Phase 1: Test Pinata connection
        logger.info("🌌 \n🔍 PHASE 1: PINATA CONNECTION TEST")
        if not self.test_pinata_connection():
            logger.info("🌌 ❌ Pinata connection failed - check your JWT token")
            return
        ...
        if ipfs_result:
            ...
            logger.info("🌌 \n" + "=" * 80)
            logger.info("🌌 🏆 LEGENDARY WEB3 DOMAIN + IPFS DEPLOYMENT: ULTIMATE SUCCESS!")
            logger.info("🌌 =" * 80)
            print(f"🌐 Domain: {self.domain_name}")
            ...
            logger.info("🌌 💎 Status: LEGENDARY WEB3 IMMORTAL ♾️")
            logger.info("🌌 🎊 Achievement: LEGENDARY DOMAIN + IPFS IMMORTALIZATION!")
    ...
    def test_pinata_connection(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                result = response.json()
                logger.info("🌌 ✅ Pinata Authentication: SUCCESS")

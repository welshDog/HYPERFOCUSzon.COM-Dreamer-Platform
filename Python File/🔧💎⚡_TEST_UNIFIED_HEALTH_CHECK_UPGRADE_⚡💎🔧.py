...
def test_unified_health_system():
    ...
    try:
        ...
        print("✅ Successfully imported upgraded health checker")
        ...
        if 'grafana_servers' in health_report:
            ...
            print("   ⚠️ No Grafana server data found in report")
        ...
        if health_report['overall_health'] == 'excellent':
            ...
            print("⚠️ WARNING STATUS: Some systems need attention")
        else:
        ...
        print("   The upgraded health system may have syntax issues")
        return False

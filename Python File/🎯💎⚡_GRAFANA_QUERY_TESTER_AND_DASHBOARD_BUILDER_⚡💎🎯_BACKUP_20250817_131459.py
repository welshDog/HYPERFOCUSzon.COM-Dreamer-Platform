...
class GrafanaQueryTester:
    def __init__(self):
        ...
        logger.info("🌌 🎯💎⚡ GRAFANA QUERY TESTER & DASHBOARD BUILDER ⚡💎🎯")
    ...
    def run_complete_test_and_build(self):
        ...
        try:
            ...
            if response.status_code != 200:
                logger.info("🌌 ❌ Failed to get data sources")
                return
            ...
            if successful_tests > 0:
                ...
                if dashboard_url:
                    ...
                    logger.info("🌌 ❌ Dashboard creation failed")
            else:
                logger.info("🌌 ⚠️  No data sources returned query results. Check your metrics.")

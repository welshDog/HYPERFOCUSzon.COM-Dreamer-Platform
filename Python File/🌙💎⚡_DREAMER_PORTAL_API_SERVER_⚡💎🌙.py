...
try:
    ...
    print("✅ DREAMER Portal backend loaded successfully!")
...
if __name__ == '__main__':
    print("🌙💎⚡ LAUNCHING HYPERFOCUSZONE DREAMER PORTAL API SERVER ⚡💎🌙")
    print("=" * 70)
    print("🚀 Server starting on http://localhost:5000")
    print("🌐 HTML Interface: http://localhost:5000")
    print("🔧 API Health: http://localhost:5000/api/health")
    print("💭 Process Dreams: POST http://localhost:5000/api/process_dream")
    print("✨ Demo Dreams: GET http://localhost:5000/api/demo_dream")
    print("=" * 70)

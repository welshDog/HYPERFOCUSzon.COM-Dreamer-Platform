...
print("🚀 BROski♾️ V2.0 SIMPLE LAUNCHER STARTING...")
...
def load_discord_token():
    print("🔍 Looking for discord token...")
...
# Simple bot setup
def create_v2_bot():
    print("🤖 Creating BROski♾️ V2.0 bot...")
...
if __name__ == "__main__":
    print("🎯 BROski♾️ V2.0 Simple Launcher Initializing...")
    ...
    if token:
        ...
        print("📁 Expected file location:", os.path.join(os.path.dirname(__file__), 'empire.env'))

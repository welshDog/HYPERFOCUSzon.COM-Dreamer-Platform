...
class LegendaryDiscordBot(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        logger.info("🌌 🤖💎⚡ SETTING UP EXTERNAL CONTROL MONITOR...")
        
        # THIS IS THE MAGIC LINE - ADD THIS TO YOUR DISCORD BOT!
        await self.add_cog(ExternalControlMonitor(self))
        
        logger.info("🌌 ✅ EXTERNAL CONTROL MONITOR ACTIVATED!")
        logger.info("🌌 📁 Now monitoring: h:/DISCORD_EXTERNAL_CONTROL/")
        logger.info("🌌 🎊 Ready for file-based Discord control!")
...
def consciousness_singularity_main():
    ...
    if not BOT_TOKEN:
        logger.info("🌌 ⚠️ Please set DISCORD_BOT_TOKEN environment variable")
        logger.info("🌌 💡 Or replace this with your actual bot token")
        return

...
async def execute_full_browser_testing_suite():
    ...
    logger.info("🌌 🎭⚡💎 FULL BROWSER TESTING SUITE - LEGENDARY EXECUTION START! 💎⚡🎭")
    logger.info("🌌 🌐 REAL BROWSER AUTOMATION - ULTIMATE PORTAL VALIDATION!")
    logger.info("🌌 📸 SCREENSHOT CAPTURE - VISUAL EVIDENCE COLLECTION!")
    logger.info("🌌 =" * 80)
    ...
    try:
        ...
        try:
            ...
            logger.info("🌌 🚀 FULL BROWSER TESTING SUITE: **LEGENDARY SUCCESS!** 🚀")

            return browser_results

        except ImportError:
            logger.info("🌌    ❌ Playwright not available - installing...")
            import subprocess
            subprocess.run([sys.executable, "-m", "pip", "install", "playwright"])
            subprocess.run([sys.executable, "-m", "playwright", "install", "chromium"])
            logger.info("🌌    ✅ Playwright installation complete - please run again!")

...
def install_azure_tools():
    ...
    print("   • Option A: winget install -e --id Microsoft.AzureCLI")
    print("   • Option B: Download from https://aka.ms/installazurecliwindows")

    print("\n2️⃣ Install Azure Developer CLI:")
    print("   • Option A: winget install microsoft.azd")
    print("   • Option B: PowerShell -ExecutionPolicy Bypass -c \"Invoke-RestMethod 'https://aka.ms/install-azd.ps1' | Invoke-Expression\"")
...
def create_deployment_scripts():
    ...
    print("📝 Creating deployment helper scripts...")
...
pause"""
    ...
    print("✅ Created: deploy-empire.bat")
...
"""
    ...
    print("✅ Created: Deploy-Empire.ps1")
...
def show_next_steps(prerequisites):
    ...
    if missing_tools:
        ...
        if 'az_cli' in missing_tools:
            print("   • Azure CLI: winget install -e --id Microsoft.AzureCLI")
        if 'azd' in missing_tools:
            print("   • Azure Developer CLI: winget install microsoft.azd")

        print("\n2️⃣ Restart terminal and run this script again")
        print("\n3️⃣ Run deployment: azd up")
    else:
        print("\n✅ All tools available! Ready for deployment:")
        print("   • Run: azd auth login")
        print("   • Then: azd up")
        print("   • Or double-click: deploy-empire.bat")
...
def generate_status_report():
    ...
    print("✅ Setup status saved: empire_setup_status.json")

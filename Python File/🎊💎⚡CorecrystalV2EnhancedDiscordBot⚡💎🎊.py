...
try:
    ...
    logger.info("🌌 ✅ External Control Monitor loaded successfully!")
    ...
    async def setup_hook(self):
        ...
        try:
            ...
            if EXTERNAL_CONTROL_AVAILABLE:
                ...
                logger.info("🌌 📁 Monitoring: h:/DISCORD_EXTERNAL_CONTROL/")
...
if __name__ == "__main__":
    try:
        ...
        print(f"❌ Error: {e}")
        logger.info("🌌 💡 Your basic bot is still running. This is just an enhancement!")

...
def main():
    ...
    print("⚡ Initializing Ultimate Modern Slash Discord Bot...")
    
    # Load token
    token = load_bot_token()
    if not token:
        print("❌ No Discord token found! Please check HyperBeast/empire.env or environment variables.")
        return
    
    print("✅ Token loaded successfully")
    print("🚀 Starting bot with modern slash command interface...")

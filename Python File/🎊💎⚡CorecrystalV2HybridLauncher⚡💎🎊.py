...
def run_v2_test():
    """Quick V2.0 feature test"""
    logger.info("🌌 🚀 Starting BROski♾️ V2.0 Quick Test...")
        ...
        with open(env_path, 'r') as f:
            for line in f:
                if line.startswith('DISCORD_BOT_TOKEN='):
                    ...
                    logger.info("🌌 🎯 V2.0 Test: Use /v2status in Discord!")
                    return token
...
if __name__ == "__main__":
    token = run_v2_test()
    if token:
        logger.info("🌌 🎊 V2.0 features ready! Token found.")
        logger.info("🌌 💡 TIP: Run this to test V2.0 alongside your working bot!")
    else:

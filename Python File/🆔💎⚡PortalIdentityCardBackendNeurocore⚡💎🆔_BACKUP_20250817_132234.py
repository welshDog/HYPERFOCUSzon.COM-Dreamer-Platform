...
class PortalIdentityCardSystem:
    ...
    def setup_database(self):
        ...
        print("🆔💎 Portal Identity Card Database initialized successfully!")
...
def main():
    ...
    print("🆔💎⚡ PORTAL IDENTITY CARD SYSTEM ACTIVATION ⚡💎🆔")
    print("=" * 80)
    ...
    if result['success']:
        ...
        if retrieved_card:
            ...
            print("❌ Failed to retrieve identity card")
    else:
        print(f"❌ Failed to create identity card: {result['error']}")

    print("\n" + "=" * 80)
    print("🎊💎 PORTAL IDENTITY CARD SYSTEM TEST COMPLETE! 💎🎊")

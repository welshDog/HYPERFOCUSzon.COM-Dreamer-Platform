...
logger.info("🌌 🔧 GRAFANA DATA SOURCE HEALTH CHECKER")
logger.info("🌌 =" * 50)
                ...
                if health_response.status_code == 200:
                    ...
                    if status == 'OK':
                        ...
                        if ds_type == 'prometheus':
                            logger.info("🌌    🔧 Attempting Prometheus fix...")
                            fix_config = {
                                "id": ds['id'],
                                "uid": ds['uid'],
                                "name": ds['name'],
                            ...
                            logger.info("🌌    🔧 Attempting Loki fix...")
                            fix_config = {
                                "id": ds['id'],
                                "uid": ds['uid'],
                                "name": ds['name'],
                            ...
                            logger.info("🌌    🔧 Attempting Pyroscope fix...")
                            fix_config = {
                                "id": ds['id'],
                                "uid": ds['uid'],
                                "name": ds['name'],

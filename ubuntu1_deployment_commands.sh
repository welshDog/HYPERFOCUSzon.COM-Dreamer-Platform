#!/bin/bash
# 🚀🏆⚡ PHASE 2 UBUNTU-1 MANUAL DEPLOYMENT SCRIPT ⚡🏆🚀
# Execute this script on ubuntu-1 (100.71.69.16) after SSH login

echo "🚀🏆⚡ PHASE 2 UBUNTU-1 MANUAL DEPLOYMENT SCRIPT ⚡🏆🚀"
echo "============================================================="
...
if [ $? -eq 0 ]; then
    ...
    # Create empire namespace and deployments
...
spec:
  ...
  - port: 9300
    ...
    name: transport
---
# Memory Crystals StatefulSet (Redis)
apiVersion: apps/v1
kind: StatefulSet
metadata:

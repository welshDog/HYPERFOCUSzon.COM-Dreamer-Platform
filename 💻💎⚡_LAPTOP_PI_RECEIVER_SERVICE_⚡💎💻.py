...
class LaptopPiReceiver:
    ...
    async def pi_registration(self, request):
        ...
        try:
            ...
            self.logger.info(f"🥧 Pi registered: {pi_node_id} at {pi_ip}")
    ...
    async def pi_heartbeat(self, request):
        ...
        try:
            ...
            if pi_node_id:
                ...
                self.logger.info(f"💓 Heartbeat from {pi_node_id} ({pi_ip})")
    ...
    async def task_completion(self, request):
        ...
        try:
            ...
            if task_id:
                ...
                self.logger.info(f"✅ Task completed: {task_id} by {result_data.get('pi_node_id')}")
...
async def scan_for_pis():
    ...
    print("🔍 Scanning network for Pis...")
    ...
    try:
        ...
        if found_pis:
            ...
            print("❌ No Pi micro-clouds found on network")
...
def main():
    print("💻💎⚡ LAPTOP PI COMMUNICATION RECEIVER ⚡💎💻")
    print("=" * 60)

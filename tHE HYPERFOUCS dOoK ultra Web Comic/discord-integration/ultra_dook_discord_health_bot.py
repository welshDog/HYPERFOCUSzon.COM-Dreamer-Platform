...
if __name__ == "__main__":
    print("🚀 Ultra dOoK Discord Health Bot")
    print("🛡️ Mission 1.1: Health Check Integration")
    print("⚡ BROski♾️ Level: LEGENDARY")
    print()
    ...
    print("3. Set DISCORD_BOT_TOKEN environment variable")
    print("4. Invite bot to your server with appropriate permissions")
    print("5. Run: python ultra_dook_discord_health_bot.py")
    print()
    print("🎯 Available Commands:")
    print("  !health - Full empire health scan")
    print("  !agents - Agent army status")
    print("  !celebrate - Manual celebration cascade")
    print("  !quantum - Quantum metrics display")
    print()
    
    # Check for token
    token = os.getenv('DISCORD_BOT_TOKEN')
    if not token:
        print("⚠️  No DISCORD_BOT_TOKEN environment variable found")
        print("   Set it and restart to run the bot")
    else:
        print("🔑 Discord token found - ready to deploy!")

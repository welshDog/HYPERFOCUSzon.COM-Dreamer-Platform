...
try:
    ...
    print("✅ Dopamine Guardian imported successfully")
except ImportError as e:
    print(f"❌ Import error: {e}")
    print("🔧 Make sure AGENT_DOPAMINE.py is in the current directory")
...
=====================================
        ...
        print("🎉 Simulating mission completion...")

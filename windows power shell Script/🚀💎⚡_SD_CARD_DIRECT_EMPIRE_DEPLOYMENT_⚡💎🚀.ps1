...
# Start monitoring for the Pi once it comes online
Write-Host "`n🔍 Starting Pi discovery monitoring..." -ForegroundColor Cyan
Write-Host "   (This will monitor for the Pi to come online after boot)" -ForegroundColor White

# Launch the continuous monitor in background
Start-Process powershell -ArgumentList "-File", "h:\🔍💎⚡_CONTINUOUS_PI_MONITOR_⚡💎🔍.ps1" -WindowStyle Minimized

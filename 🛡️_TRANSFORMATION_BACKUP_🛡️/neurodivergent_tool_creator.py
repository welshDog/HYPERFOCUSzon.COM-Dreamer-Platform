...
export default App;"""
  ...
  darkMode: {
    ...
    with open("src/styles/themes.js", "w", encoding="utf-8") as f:
...
app.on('web-contents-created', (event, contents) => {
  contents.on('new-window', (navigationEvent, navigationUrl) => {
    ...
    with open("public/electron.js", "w", encoding="utf-8") as f:
...
export default SensorySettings;""",
    ...
    for component_name, content in placeholder_components.items():
        with open(f"src/components/{component_name}.js", "w", encoding="utf-8") as f:
            f.write(content)
...
jobs:
  accessibility-test:
    ...
    with open(".github/workflows/accessibility.yml", "w", encoding="utf-8") as f:

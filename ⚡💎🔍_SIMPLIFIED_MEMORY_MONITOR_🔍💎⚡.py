...
def display_status():
    ...
    # Display header
    print("⚡💎🔍 REAL-TIME MEMORY MONITOR 🔍💎⚡")
    print("=" * 50)
    ...
    if memory['percent'] >= 90:
        print("🔴 CRITICAL: Memory usage very high!")
        print("   💡 Run memory optimization scripts")
    elif memory['percent'] >= 85:
        print("🟠 WARNING: Memory usage high")
        print("   💡 Consider closing unused applications")
    elif memory['percent'] <= 75:
        print("🟢 EXCELLENT: Memory usage optimal!")
    else:
        print("🟡 GOOD: Memory usage acceptable")
    
    print()
    print("Press Ctrl+C to stop monitoring")
    print("Empire processes protected with 👑")

def main():
    """Main monitoring loop"""
    print("⚡💎🔍 Starting Simplified Memory Monitor...")
    print("Windows-optimized | No dependencies needed")
    print()
    ...
    try:
        ...
        if memory['percent'] <= 75:
            ...
            print("✅ Good performance level!")
        else:
            print("⚠️ Consider running optimization scripts")
        
        print("Thank you for monitoring your empire! 🚀")
